...
pub fn point_is_in_line(p: &Point, ln: &Line) -> bool {
    let k11 = ln.func_args()[0][0];
    let k12 = ln.func_args()[0][1];
    let b1 = ln.func_args()[0][2];
    let k21 = ln.func_args()[1][0];
    let k22 = ln.func_args()[1][1];
    let b2 = ln.func_args()[1][2];
    (k11 * p.y + k12 * p.x == b1) && (k21 * p.y + k22 * p.x == b2)
}

pub fn point_is_in_plane(p: &Point, pn: &Plane) -> bool {
    let k1 = pn.func_args()[0];
    let k2 = pn.func_args()[1];
    let k3 = pn.func_args()[2];
    let b = pn.func_args()[3];
...
pub fn line_is_parallel(ln1: &Line, ln2: &Line) -> bool {
    let k111 = ln1.func_args()[0][0];
    let k112 = ln1.func_args()[0][1];
    let b11 = ln1.func_args()[0][2];
    let k121 = ln1.func_args()[1][0];
    let k122 = ln1.func_args()[1][1];
    let b12 = ln1.func_args()[1][2];
    let k211 = ln2.func_args()[0][0];
    let k212 = ln2.func_args()[0][1];
    let b21 = ln2.func_args()[0][2];
    let k221 = ln2.func_args()[1][0];
    let k222 = ln2.func_args()[1][1];
    let b22 = ln2.func_args()[1][2];
...
pub fn plane_is_parallel(pn1: &Plane, pn2: &Plane) -> bool {
    let k11 = pn1.func_args()[0];
    let k12 = pn1.func_args()[1];
    let k13 = pn1.func_args()[2];
    let b1 = pn1.func_args()[3];
    let k21 = pn2.func_args()[0];
    let k22 = pn2.func_args()[1];
    let k23 = pn2.func_args()[2];
    let b2 = pn2.func_args()[3];
